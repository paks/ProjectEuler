...
//-----------------------------------------------------------------------
// <copyright file="fareyneighbour.fs" >
...
let rec fareyNeigh fraction neighbour order = 
                let (a,b) = neighbour
                let (c,d) = fraction
                if b+d > order then
                    neighbour
                    ...
                    let next = (a+c,b+d)
                    fareyNeigh fraction next order    

let solution = fareyNeigh fraction neighbour order |> fst
